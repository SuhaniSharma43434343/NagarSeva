...
import { Colors, Typography, BorderRadius, Spacing } from '../../engineerTheme';

type ConfirmationRouteProp = RouteProp<EngineerStackParamList, 'Confirmation'>;
type NavigationProp = NativeStackNavigationProp<EngineerStackParamList, 'Confirmation'>;
