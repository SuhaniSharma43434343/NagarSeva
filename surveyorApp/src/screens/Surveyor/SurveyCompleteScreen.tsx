...
import { SurveySession, RouteAssignment } from '../../types';
import { SurveyorStackParamList } from '../../navigation/SurveyorNavigator';

type NavigationProp = NativeStackNavigationProp<SurveyorStackParamList, 'SurveyComplete'>;
type RouteType = RouteProp<SurveyorStackParamList, 'SurveyComplete'>;
